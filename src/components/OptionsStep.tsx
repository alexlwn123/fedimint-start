    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-white mb-4">
          {serverType === 'cloud' ? 'Choose Cloud Provider' : 'Choose Platform'}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {options.map((option, index) => (
          <div
            key={option.name}
            className="bg-gray-800 border border-gray-700 rounded-2xl shadow-lg hover:shadow-xl hover:border-blue-500/30 transition-all duration-300 transform hover:scale-[1.02] cursor-pointer overflow-hidden"
          >
            <div className="p-6">
              ...
              <button className="w-full mt-6 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 text-sm shadow-lg">
